...
`cloud-itonami-isco-7311` is an OSS open-occupation blueprint. Governance covers
...
- an instrument-repair/calibration-execution decision, and any override of a
  workshop safety officer's judgment, stay permanently outside this actor's
  op-allowlist.
...
- attempting to route an instrument-repair/calibration-execution decision, or a
