(ns instrumentmaker.actor
  "InstrumentMakerActor — the ISCO-08 7311 precision-instrument
  ...
  instrument-repair/calibration-execution decision (e.g. a specific
  instrument-repair or calibration procedure) or override a workshop
  ...
  SCHEDULING/LOGISTICS ONLY — it never performs instrument-repair or
  calibration work itself."
